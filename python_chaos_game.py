...
#Params
image_size = 1500; #500x500
n_points = 100; #Número de puntos a dibujar
point_size = 1; #Tamaño de punto
prop = 2/3; #Proporción de división de distancia entre puntos
repetir_vertice = True; #Puede repetir el mismo vertice dos veces seguidas
save = True
save_path = "/res"
#vértices de la forma
shape_coords = [[0,image_size//2],[image_size,image_size],[image_size,0]]
...
if (__name__ == '__main__'):
    ...
    if(save):
        ...
        filename = "puntos={};vertices={};fraccion={};repetir_vertice={};;{}.jpg".format(n_points,\
            len(shape_coords),prop,repetir_vertice,datetime.datetime.now())
