# Uso
<br>
Al correr el archivo principal python_chaos_game.py se empieza a generar el posible fractal con puntos pseudoaleatorios.
...
Cuando está listo se guarda en la carpeta [res](), como nombre le asigna ciertas configuraciones ajustables.
<br>
